  ...
  methods: {
    fetchProduct: function fetchProduct() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _productData$discount, _productData$discount2, response, productData, hasDiscount, _error$response, _error$response2, _error$response3;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _this.product = null;
              _context.next = 6;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().get("/client/products/".concat(_this.$route.params.slug));
            case 6:
              response = _context.sent;
              // Transform API response to match component data structure
              productData = response.data.data;
              hasDiscount = ((_productData$discount = productData.discount) === null || _productData$discount === void 0 ? void 0 : _productData$discount.active) && ((_productData$discount2 = productData.discount) === null || _productData$discount2 === void 0 ? void 0 : _productData$discount2.amount) > 0;
              _this.product = {
                ...
                images: productData.images.map(function (img) {
                  return {
                    url: img.url,
                    alt: img.alt
                  };
            ...
            case 12:
              ...
              _this.product = null;
              _this.error = ((_error$response3 = _context.t0.response) === null || _error$response3 === void 0 ? void 0 : _error$response3.status) === 404;
            case 17:
              _context.prev = 17;
              _this.loading = false;
